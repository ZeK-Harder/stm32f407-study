...
void key_init(void)
{
    ...
    gpio.Pin = ((uint16_t)0x0010) | ((uint16_t)0x0008) | ((uint16_t)0x0004);
    gpio.Mode = (0x0UL << 0U);
    gpio.Pull = 0x00000001U;
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), &gpio);


    gpio.Pin = ((uint16_t)0x0001);
    gpio.Pull = 0x00000002U;
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), &gpio);
}
...
uint8_t key_scan(void)
{
    ...
    if ((HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0010)) == GPIO_PIN_RESET)) key = 1;
    else if ((HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0008)) == GPIO_PIN_RESET)) key = 2;
    else if ((HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0004)) == GPIO_PIN_RESET)) key = 3;
    else if ((HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0001)) == GPIO_PIN_SET)) key = 4;
